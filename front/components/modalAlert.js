...
const ModalAlert = ({identification, type, contact, vehicule, updateState}) => {
    ...
    return (
        <View>
            ...
            {selectedOption && (
                <AlertMessageForm option={selectedOption} identification={identification} type={type} contact={contact} vehicule={vehicule} updateState={updateState}></AlertMessageForm>
            )}
        </View>
